                                    ...
                                    <div class="modal-dialog">
                                        ...
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                ...
                                                <h4>Personeelslid: <?php echo $persoon->name ;?></h4>
                                            </div>
                                            <div class="modal-body">
                                                <p>Bent u echt zeker dat u dit personeelslid wilt verwijderen?</p>
            ...
            <div class="modal fade" id="wijzigModal{{$persoon->id}}" role="dialog">
                <div class="modal-dialog">
                    ...
                    <div class="modal-content">
                        <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal">&times;</button>
                            <h4 class="modal-title" id="frmHeader"> Wijzigen van {{$persoon->name}}</h4>
                        </div>
                        <div class="modal-body">
                            <form class="form-horizontal"  action="{{route('wijzigPersoneel')}}" method="post">
                                <div class="form-group" style="padding: 10px;">
                                    <label for="frmPersoneelNaam">Naam:</label>
                                    <input type="text" class="form-control" id="frmWijzigPersoneelNaam" name="frmWijzigPersoneelNaam" value="{{$persoon->name}}" required>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-xs-6 col-sm-6 col-md-6">
                                        <div class="form-group" style="padding: 10px;">
                                            ...
                                            <input type="text" class="form-control" id="frmWijzigPersoneelGebruikersNaam"  name="frmWijzigPersoneelGebruikersNaam" value="{{$persoon->email}}" required>
                                        </div>
                                    </div>
                                </div>
